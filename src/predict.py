...
class Predict:
    ...
    def __init__(self):
        ...
        self.encoder.classes_ = np.load(os.path.join(self.model_dir, "label_encoder.npy"), allow_pickle=True)
    ...
    def predict(self, data):
        ...
        output["predictions"] = self.encoder.inverse_transform(np.argmax(predictions, axis=1)).tolist()
