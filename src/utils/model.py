...
def create_model(
    ...
    if model_type == "albert":
        ...
        layer_bert = bert.BertModelLayer.from_params(model_params, name="albert")
    elif model_type == "bert":
        model_ckpt = os.path.join(model_dir, "bert_model.ckpt")
        model_params = bert.params_from_pretrained_ckpt(model_dir)
        layer_bert = bert.BertModelLayer.from_params(model_params, name="bert")
    ...
    logits = keras.layers.Dense(units=model_params["hidden_size"], activation="tanh")(cls_out)
